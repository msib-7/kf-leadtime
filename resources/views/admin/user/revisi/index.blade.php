...
@section('scripts')
    ...
    <script>
        const _URL = "{{ route('admin.user.revisi.index') }}";
        ...
        $(document).ready(function () {
            ...
            let userTable = $("#dt_userRev").DataTable({
                processing: true,
                serverSide: true,
                order: [[1, 'desc']],
                ajax: {
            ...
            $('#employee').select2({
                ...
                ajax: {
                    url: "{{ route('admin.user.revisi.getHrisEmployee') }}",
                    dataType: 'json',
                    delay: 150,
                    processResults: data => {
                        return {
            ...
            $('#savedata').click(function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.user.revisi.store') }}",
                    type: "POST",
                    headers: {
